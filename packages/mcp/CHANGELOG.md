...
- [#140](https://github.com/pradeepmouli/skillit/pull/140) [`2043194`](https://github.com/pradeepmouli/skillit/commit/2043194469364adbd5bbeaa298b0899acb82cfae) Thanks [@pradeepmouli](https://github.com/pradeepmouli)! - Bump `@apidevtools/json-schema-ref-parser` from `^15.3.5` to `^16.0.3` (runtime dependency). Verified `$RefParser.dereference()` API, default export, and the resolver-disabled error path (`UnmatchedResolverError`) used by `resolveSchema()` are unchanged; all schema-ref tests pass.
- Updated dependencies [[`7acd316`](https://github.com/pradeepmouli/skillit/commit/7acd316c38288215f70ba0afe29e8c29f16072c4)]:
  - @skillit/core@4.0.3
  - @skillit/target-mcp-protocol@5.0.3
...
- Updated dependencies [[`c57ad12`](https://github.com/pradeepmouli/skillit/commit/c57ad1265a86a49c324c944e180327ff93a7dc70)]:
  - @skillit/core@4.0.2
  - @skillit/target-mcp-protocol@5.0.2
...
- Updated dependencies [[`6467ad2`](https://github.com/pradeepmouli/skillit/commit/6467ad2d1399ea19de8ab625341a9815d37b84cf)]:
  - @skillit/core@4.0.1
  - @skillit/target-mcp-protocol@5.0.1
